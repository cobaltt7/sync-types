...
pkg.devDependencies = Object.fromEntries(Object.entries(pkg.devDependencies).map(([dependency, version]) => {
	...
	if (version !== transformed) console.log(`Bumped ${dependency} from ${version} to ${transformed}`);
